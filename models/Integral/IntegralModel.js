...
class IntegralModel {
   ...
   static async queryList(data) {
        ...
        if(Object.keys(searchVal).length === 0){
            return await Integral.findAndCountAll({
                order: [
                    ['updateTime', 'DESC']
                ],
                limit: limit,
